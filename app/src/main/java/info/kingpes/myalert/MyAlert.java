...
public class MyAlert {
    ...
    public MyAlert(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder setAnimation(Animationez animation) {
        ...
        public MyAlert build() {
            ...
            dialog.setContentView(R.layout.myalert);
